...
copy bin\x86_64-win64-Lua53\qvcl.dll .tmp\.zip\x64-Lua53
...
echo \x64-Lua54  -- для QUIK 8.11 и далее (в случае выбора Lua 5.4 для выполнения скрипта) >> .tmp\.zip\ReadMe.txt
